...
// ================== QUESTION BANK ==================
// Example structure (add remaining questions in same format)
const questionBank = [
  // ===== 3 MARK QUESTIONS =====
   {
      "id": "Q1",
  ...
  // ➜ Add the remaining questions here in same structure.
];
...
let inExam = false;
let completedLocked = false; // completed + 20-day lock
