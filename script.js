...
const questionBank = [
  ...
  // ➜ Add more questions here in same format if you want (from your 160+ bank)
];
...
let currentAppSection = "loginSection";
...
function setupHistoryLock() {
  ...
  window.addEventListener("popstate", () => {
    ...
    // Force user to remain on current logical section
    if (inExam && !quizFinished) {
      showSection("examSection");
      issueWarning("Navigation attempt detected. Continue the test on this page.");
