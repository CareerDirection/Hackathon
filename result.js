document.addEventListener("DOMContentLoaded", () => {
  ...
  const resultCandidateExtra = document.getElementById("resultCandidateExtra");
  ...
  resultCandidateExtra.textContent =
    `College: ${data.college} | Stream: ${data.stream}`;
  ...
  if (violationAuto) {
    ...
    // In violation mode we still show badge strip image (rules) but label as "Violation".
    badgeLabel.textContent = "Security Violation";
  } else {
